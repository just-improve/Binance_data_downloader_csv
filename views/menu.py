...
class MenuView(Frame):
    def __init__(self, *args, **kwargs):
        ...
        label_symbol.grid(row=4, column=0, padx=10, pady=10)

        label_currency = Label(self, text='pair')
        label_currency.grid(row=4, column=2, padx=10, pady=10)

        self.symbol_entry = Entry(self)
        self.symbol_entry.insert(0,'BTC')
        self.symbol_entry.grid(row=5, column=0, padx=10, pady=10)

        self.pair_entry = Entry(self)
        self.pair_entry.insert(0, 'USDT')
        self.pair_entry.grid(row=5, column=2, padx=10, pady=10)
        ...
        label_end_date.grid(row=6, column=2, padx=10, pady=10)

        self.start_date_entry = Entry(self)
        self.start_date_entry.insert(0, '2023-02-16')
        self.start_date_entry.grid(row=7, column=0, padx=10, pady=10)

        self.end_date_entry = Entry(self)
        self.end_date_entry.insert(0, '2023-02-20')
        self.end_date_entry.grid(row=7, column=2, padx=10, pady=10)

        label_interval = Label(self, text='Interval')
        label_interval.grid(row=8, column=0, padx=10, pady=10)

        self.interval_entry = Entry(self)
        self.interval_entry.insert(0, '5m')
        self.interval_entry.grid(row=9, column=0, padx=5, pady=5)

        self.test_btn = Button(self, text="Pobierz dane")
        self.test_btn.grid(row=9, column=2, padx=10, pady=10)
